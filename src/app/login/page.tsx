  ...
  return (
    <div className="w-[390px] h-[667px]">
      ...
      <div className="flex flex-col justify-center items-center">
        <div>
          <button
            className="flex justify-center items-center w-[330px] h-[44px] rounded-[5px] border-[1px] border-[solid] border-[#E9E9E9] bg-[#FFF] shadow-login mb-[14px]">
        ...
        <div>
          <div className="mb-[20px]">
            <button
              className="w-[330px] h-[44px] rounded-[5px] bg-[#FFF500] shadow-login flex items-center justify-center"
              onClick={() => kakaoLogin()}>
              <Image alt="카카오" src={kakaoBtn}/>
              <p className="ml-[6px] text-[18px]">카카오로 계속하기</p>
            </button>
          </div>
        </div>
        <div>
