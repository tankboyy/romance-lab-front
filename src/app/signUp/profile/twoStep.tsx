		...
		<div>
			...
			<div className="text-center space-y-[15px] mb-[40px]">
				...
				<div className="flex justify-center space-x-[10px] text-[16px]">
					<button
						className={already ? "w-[165px] h-[40px] rounded-[5px] border-[1px] border-black border-solid" : "w-[165px] h-[40px] rounded-[5px] border-[1px] border-[#E2E2E2] border-solid text-[#AAA]"}
          ...
          <div>
              ...
              <div className="border-b-[1px] border-black border-b-solid pb-[2px] pl-[5px] flex justify-between">
                  <input type="text" value={inputValue} placeholder="연인의 회원코드를 입력해주세요" className="w-4/6"
