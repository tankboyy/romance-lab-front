...
export default function ThreeStep(props: propsType) {
	return (
		<div>
			...
			<div className="flex">
				<button
					className={!true ? "w-full h-[40px] rounded-[5px] bg-[#3668EA] text-[#FFF] text-[12px] absolute bottom-3" : "w-full h-[40px] rounded-[5px] bg-[#D9D9D9] text-[#FFF] text-[12px] absolute bottom-3"}
					disabled={true}
					onClick={() => alert("끝")}
				>
					<p>회원정보 입력 완료하기</p>
